package cn.edu.gdmec.s07150751.mymap;
        ...
        OnGetPoiSearchResultListener getPoiSearchResultListener =new OnGetPoiSearchResultListener() {
            ...
            public void onGetPoiResult(PoiResult poiResult) {
                ...
                if (poiResult.error == SearchResult.ERRORNO.NO_ERROR) {
                    ...
                    overlay.addToMap();
                    overlay.zoomToSpan();
                    Toast.makeText(MainActivity.this, "总共查询" + poiResult.getTotalPageNum() + "各兴趣点,分为" + poiResult.getTotalPageNum() + "页", Toast.LENGTH_SHORT).show();
                    return;
                }
            }
            @Override
